...
export async function updateData(dataPaths: Record<string, any>): Promise<void> {
...
export function deleteData(paths: string | string[]): Promise<void> {
    ...
    throw new Error("Invalid input: paths should be a string or an array of strings.");
}
